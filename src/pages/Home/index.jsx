...
import CardWithImageOnRight from "./Components/CardWithImageOnRight";
import RatestList from "./Components/RatestList";
import Awards from "./Components/Awards";
import VisaCart from "./Components/VisaCart";
...
<div className="w-[90%] mx-auto">
  <div className="text-center">
    <h2 className="text-4xl font-semibold text-gray-400 sm:text-3xl md:text-5xl mt-[12%]">
